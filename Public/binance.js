...
function simple() {
  ...
  fetch(
    "https://rest.coinapi.io/v1/exchangerate/" +
      selects +
      "/USD?apikey= AFBA9527-0ECD-49FC-9B02-EFFD2BB92A64"
  )
    .then((response) => {
...
function sellPerson(event, id) {
  ...
  document
    ...
    .setAttribute("onclick", "javascript: sell(event," + id + ") ");
...
window.onload = function (id) {
  ...
  // JSON.parse(localStorage.getItem("coin"))
  JSON.parse(localStorage.getItem("coin")) == undefined
    ? (coin = [])
